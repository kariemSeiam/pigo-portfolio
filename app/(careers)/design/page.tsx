/**
 * Design Domain Page
 * Figma Playground Theme
 * 
 * @see CLAUDE.md - Section 15 for complete documentation
 */
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <motion.button
              className="px-8 py-4 text-lg bg-design-primary text-black rounded-xl font-bold hover:shadow-elevation-2 transition-shadow"
            ...
            <motion.button
              className="px-8 py-4 text-lg border-2 border-design-primary text-design-primary rounded-xl font-bold hover:bg-design-primary/10"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Download Resume
